  ...
  template: `
    <div class="d-flex align-items-center gap-3 mb-4">
      ...
      <div>
        ...
        <p class="text-muted small mb-0">Completa los datos para crear tu rifa</p>
      </div>
    </div>
        ...
        <div class="col-lg-8">
          <div class="card border-0 shadow-sm mb-4">
            <div class="card-header bg-white fw-semibold">
              <i class="bi bi-info-circle me-2 text-primary"></i>Informacion basica
            </div>
            <div class="card-body">
              <div class="mb-3">
                <label class="form-label fw-medium" for="title">Titulo de la rifa *</label>
              ...
              <div class="mb-3">
                <label class="form-label fw-medium" for="description">Descripcion</label>
                <div class="position-relative">
                  <textarea id="description" class="form-control pe-5 pb-4" rows="4"
                            formControlName="description"
                            maxlength="1500"
                            placeholder="Describe los detalles de tu rifa..."
                            [class.is-invalid]="t('description') && form.get('description')?.invalid"></textarea>
                  <div class="position-absolute end-0 bottom-0 me-2 mb-2 px-2 py-1 rounded-2 small"
                       style="font-size:.72rem; pointer-events:none; z-index:2; background:rgba(255,255,255,.96); color:#6b7280; box-shadow:0 1px 4px rgba(0,0,0,.06); line-height:1;">
                    {{ descriptionLength() }}/1500
                  </div>
                </div>
                <div class="invalid-feedback d-block mt-1"
                     [class.invisible]="!t('description') || !form.get('description')?.hasError('maxlength')">
                  La descripcion admite hasta 1500 caracteres.
                </div>
              </div>

              <div class="row g-3">
                <div class="col-sm-6">
                  <label class="form-label fw-medium" for="totalNumbers">Total de numeros *</label>
                  ...
                  <div class="invalid-feedback">Minimo 2 numeros</div>
                </div>
                <div class="col-sm-6">
                  <label class="form-label fw-medium" for="pricePerNumber">Precio por numero (ARS) *</label>
          ...
          <div class="card border-0 shadow-sm mb-4">
            ...
            <div class="card-body">
              ...
              <div class="mt-3">
                <label class="form-label fw-medium" for="prizeDescription">Descripcion del premio</label>
        ...
        <div class="col-lg-4">
          <div class="card border-0 shadow-sm mb-4">
            ...
            <div class="card-body">
              ...
              <div class="mb-3">
                <label class="form-label fw-medium" for="drawMethod">Metodo de sorteo</label>
                <select id="drawMethod" class="form-select" formControlName="drawMethod">
                  <option value="MANUAL">Manual (vos lo ejecutas)</option>
                  <option value="AUTOMATIC">Automatico (al llegar la fecha)</option>
                </select>
              </div>
              <div class="mb-3">
                <label class="form-label fw-medium" for="drawPolicy">Politica del sorteo</label>
                <select id="drawPolicy" class="form-select" formControlName="drawPolicy">
                  <option value="PAID_ONLY">Solo numeros pagados</option>
          ...
          <div class="card border-0 shadow-sm bg-primary bg-opacity-10 border-primary">
            <div class="card-body">
              ...
              <div class="d-flex justify-content-between mb-1">
                <span class="small text-muted">Total numeros</span>
                <span class="fw-semibold">{{ form.get('totalNumbers')?.value ?? 0 }}</span>
              </div>
              <div class="d-flex justify-content-between mb-1">
                <span class="small text-muted">Precio por numero</span>
                <span class="fw-semibold">$ {{ form.get('pricePerNumber')?.value ?? 0 }}</span>
              </div>
              <hr class="my-2">
              <div class="d-flex justify-content-between">
                <span class="small fw-medium">Recaudacion potencial</span>
